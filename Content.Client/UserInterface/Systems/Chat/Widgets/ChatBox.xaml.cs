...
#pragma warning restore RA0003
{
    ...
    private SpeechRecognitionWrapper _speechRecognitionWrapper;
    ...
    public ChatBox()
    {
        ...
        _speechRecognitionWrapper = new SpeechRecognitionWrapper();
        _speechRecognitionWrapper.SpeechRecognized += OnSpeechRecognized;
        SpeechToTextButton.OnButtonDown += StartSpeechToText;
        SpeechToTextButton.OnButtonUp += StopSpeechToText;
    ...
    private void StartSpeechToText(BaseButton.ButtonEventArgs buttonEventArgs)
    {
        _speechRecognitionWrapper.StartRecognition();
    }

    private void StopSpeechToText(BaseButton.ButtonEventArgs buttonEventArgs)
    {
        _speechRecognitionWrapper.StopRecognition();
    }

    private void OnSpeechRecognized(string text)
    {
        ChatInput.Input.Text = text;
    }
}
